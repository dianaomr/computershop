    ...
    <header dir="rtl" className="w-full relative z-50">
      <div className="header flex flex-col md:flex-row justify-between items-center p-4 md:p-6 gap-4">
        ...
        <div className="w-full md:w-96 relative">
          <input
            ...
            className="border w-full h-10 rounded-3xl px-4"
          />

          {showDropdown && (
            <div className="absolute top-12 w-full bg-white shadow-xl rounded-xl border max-h-80 overflow-y-auto z-50">
      ...
      <nav className="navbar">
        <div className="flex justify-between items-center px-4 md:px-24 py-4">
          ...
          <p><Link href="/client/cart"><ShoppingCart size={32}/></Link></p>
          <p><Link href="/client/favorites"><FaHeart size={32} className="FaHeart cursor-pointer hover:scale-110 transition"/></Link></p>
