...
const Footer: React.FC = () => {
    return (
      <footer className="bg-gray-800 text-black text-center p-4 mt-10">
         <FaClock className="clock text-blue-500 text-3xl mb-2" />
       ...
       <div className="contact p-6 rounded-lg shadow-lg flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4">
         <div className="phone flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow w-full md:w-1/2">
           <FaHeadphones className="text-blue-500 text-3xl mb-2" />
           <h2 className="text-lg font-bold">تلفن تماس و فکس</h2>
           <p className="text-lg">۰۲۱ - ۹۱۰۰۰۱۰۰</p>
           <p className="text-lg">۰۲۱ - ۶۱۹۳۰۰۰۰</p>
         </div>
 
         <div className="email flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow w-full md:w-1/2">
           <FaEnvelope className="text-black-500 text-3xl mb-2" />
         ...
         <div className="email flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow w-full md:w-1/2">
           <FaMapMarkedAlt className="text-black-500 text-3xl mb-2" />
